...
/*
 * Pre-allocate 64GiB mmap-ed region at startup and then use this memory.
 * Lets us keep a separate dynamic memory allocation region.
 *
...
static void initMmap() {
  ...
  global_mmap_ptr_max = (void *)((char *)(global_mmap_ptr) +
    MMAP_PREALLOC_SIZE);
